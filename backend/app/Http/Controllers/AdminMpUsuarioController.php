<?php namespace App\Http\Controllers;
	...
	class AdminMpUsuarioController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:mp_usuario','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			$this->form[] = ['label'=>'Estado','name'=>'estado','type'=>'select2','validation'=>'required','width'=>'col-sm-10','dataenum'=>'A|Activa;I|Inactiva'];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:mp_usuario","placeholder"=>"Please enter a valid email address"];
